<template>
  <div>
    ...
    <!-- 登录弹框 -->
    <el-dialog title="登录" :visible.sync="dialogFormVisible" :before-close="reset">
      <el-form>
        <!-- 账号 -->
        ...
        <el-form-item label="密码" :label-width="formLabelWidth">
          <!-- 密码输入框 -->
          <el-input type="password" class="bgimg2" v-model="form.upwd" autocomplete="off" @blur="bull" @focus="focuu"
            placeholder="请输入您的密码">
          </el-input>
          <!-- 密码输入框下方内容 -->
          <span class="ts" :class="login_upwd==0?'active':''">以字母开头，长度在6-18之间，只能包含字符、数字和下划线</span>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogFormVisibleregister=true,dialogFormVisible=false,form2.unum1='',
        form2.upwd1='',
        form2.upwd2='',
        ...
        reg_unum1=-1,
        reg_upwd1=-1,
        reg_phone=-1">去注册</el-button>
        <el-button type="primary" @click="login" :disabled="login_unum==2&login_upwd==2?false:''">登录</el-button>
      </div>
    </el-dialog>
    <!-- 注册弹框 -->
    <el-dialog title="注册" :visible.sync="dialogFormVisibleregister" :before-close="reset">
      <el-form>
        <el-form-item label="账号" :label-width="formLabelWidth">
          <el-input placeholder="手机号码" v-model="form2.phone" @blur="blurp" @focus="focusp"></el-input>
          <span class="ts" :class="reg_phone==0?'active':''">请输入您的手机号码</span>
        ...
        <el-form-item label="昵称" :label-width="formLabelWidth">
          <el-input v-model="form2.unum1" autocomplete="off" @blur="blurn" @focus="focusn"></el-input>
          <span class="ts" :class="reg_unum1==0?'active':''">用户名需为3~16为字母或数字的组合</span>
        ...
        <el-form-item label="密码" :label-width="formLabelWidth">
          ...
          <!-- <span
            :class="upwd1_icon===0?'unull':upwd1_icon==1?'el-icon-circle-close':'el-icon-circle-check'">{{upwdTxt1}}</span> -->
          <span class="ts" :class="reg_upwd1==0?'active':''">以字母开头，长度在6-18之间，只能包含字符、数字和下划线</span>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogFormVisibleregister=false,dialogFormVisible=true,form.unum='',
        form.upwd='',
        login_unum=-1,
        login_upwd=-1,
        reg_unum1=-1,
        reg_upwd1=-1,
        reg_upwd2=-1,
        reg_phone=-1">去登录</el-button>
        <el-button type="primary" @click="register"
          :disabled="reg_unum1==2&reg_upwd1==2&reg_phone==2&reg_upwd2==2?false:''">注册</el-button>
      </div>
    </el-dialog>
