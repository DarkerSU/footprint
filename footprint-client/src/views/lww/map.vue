...
<template>
  <div class="mapbox">
    ...
    <baidu-map class="map" :center="{lng: 116.404, lat: 39.915}" :zoom="14" :scroll-wheel-zoom="true"
      :mapStyle="mapStyle" style="height:90vh" @click="paintPolyline">
      <!-- <el-button type="primary" @click="toggle('polyline')">{{ polyline.editing ? '停止绘制' : '开始绘制' }}</el-button> -->
      <!-- 自动连点 -->
      <bm-polyline :path="polylinePath" stroke-color="red" :stroke-opacity="0.8" :stroke-weight="5" :editing="true">
      </bm-polyline>
