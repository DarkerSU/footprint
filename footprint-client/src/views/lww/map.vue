...
<template>
  <div class="mapbox">
    ...
    关键词：<el-input v-model="keyword" placeholder="请输入关键词"></el-input>
    地区：<el-input v-model="location" placeholder="请输入地区"></el-input>
...
export default {
  ...
  methods: {
    ...
    geocoder.getLocation(e.point,rs=>{
      ...
      this.footprintobj.site=rs.addressComponents.city+rs.addressComponents.district+rs.addressComponents.street+rs.addressComponents.streetNumber+rs.surroundingPois[0].title//地点
